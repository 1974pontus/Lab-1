...
const scenes = [
    {
        ...
        actions: [{ right: 'ja', next: 1 }, { wrong: 'nej', next: 6 }]
    },
    {
        ...
        actions: [{ right: 'ja', next: 2 }, { wrong: 'nej', next: 6 }]
    },
    {
        ...
        actions: [{ right: 'ja', next: 3 }, { wrong: 'nej', next: 6 }]
    },
    {
        ...
        actions: [{ right: '2', next: 4 }, { wrong: '1', next: 6 }]
    },
    {
        ...
        actions: [{ right: 'ja', next: 5 }, { wrong: 'nej', next: 6 }]
    },
    {
        ...
        actions: [{ right: 'ja', next: 0 }, { wrong: 'nej', next: 6 }]
    },
    {
